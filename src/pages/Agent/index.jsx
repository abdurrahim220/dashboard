...
const Agent = () => {
	...
	const [agentList, setAgentList] = useState(agentRowData);
	...
	//         const filteredAgents = agentRowData.filter(agent => {
	...
	return (
		<>
			{/* <div className="flex gap-4 items-center w-full mb-6">
				<SearchInput placeHolder="Agent Name" />
				<SearchInput placeHolder="Commission Win" />
				<SearchInput placeHolder="Commission Loss" />
				<ToggleInput />
			</div> */}
