...
import { relatedAccountData } from "../../utils/mockData";
import AccountList from "./AccountList";
import AddAccountForm from "./Forms/AddAccountForm";
import EditAccountForm from "./Forms/EditAccountForm";

const Account = () => {
	const [accounts, setAccounts] = useState(relatedAccountData);
	...
	useEffect(() => {
		if (Object.keys(filterInputData).length === 0) {
			...
			setAccounts(relatedAccountData);
		} else {
			const filteredData = relatedAccountData.map((agentData) => {
